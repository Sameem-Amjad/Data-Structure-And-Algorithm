...
int graphDistancePizza(string location)
{
    ...
    return dijkstraAlgoPizza(0, dep);
}
struct Customer
{
    string name;
...
Node *createNode()
{
    ...
    cout << "\n                              Enter Your NUmber of Order u want to place: ";
...
void customerData(Node *p)
{
    if (isEmptyCustomer() == true)
    {
        ...
        current->distanceTravel = graphDistancePizza(current->travelTo);
